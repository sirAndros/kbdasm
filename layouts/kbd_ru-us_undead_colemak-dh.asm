...
; kbd_ru-us_undead_colemak-dh - RU/Colemak-DH hybrid keyboard layout with Caps Lock set to switch
...
if TYPEWRITER_ON_CAPS
    ...
    vkrow4 -1,            0,      "o",      "O",      WCH_NONE, WCH_NONE
...
data export
export "kbd_ru-us_undead_colemak-dh.dll", KbdLayerDescriptor, "KbdLayerDescriptor"
end data
...
versioninfo version,VOS_NT_WINDOWS32,VFT_DLL,VFT2_DRV_KEYBOARD,0,1200,\
    ...
    'FileVersion','1.0',\
    'InternalName','kbd_ru-us_undead_colemak-dh',\
    'LegalCopyright','Public domain. No rights reserved.',\
    'OriginalFilename','kbd_ru-us_undead_colemak-dh.dll',\
    'ProductName','kbdasm',\
    'ProductVersion','1.0'
